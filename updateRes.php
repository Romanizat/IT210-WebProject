...
<head>
    ...
    <title>Umami | Rezervacija izmena</title>
</head>
...
<body>
    ...
    <div class="centriranje">
        <form method="POST" action="updateR.php" style="text-align: center;">
            <h2>Koju rezervaciju biste izmenili?</h2>
            ...
            <br><br>
            <label for="kolicina">Da li biste promenili broj karata?</label>
            <br><br>
            <input type="number" name="kolicina" required step="1">
            <br> <br>
            <button type="submit" name="updateR">Izmeni</button>
            <br> <br>
        </form>
    </div>
    <footer>
