...
<body>
    ...
    <h2 style="text-align: center;">Admin Panel | Dodaj Event</h2>
...
<div class="centriranjeBody2">
    <form method="POST" action="creatEvent.php" style="text-align: center;">
        <h2>Dodajte novi event:</h2>
        ...
        <br><br>
        <button type="submit" name="creatEvent">Dodaj</button>
        <br><br>
    </form>
