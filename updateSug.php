...
<head>
    ...
    <title>Umami | Predlog izmena</title>
</head>
...
<body>
    ...
    <?php
        ...
        $sql2 = "SELECT * FROM locationsuggest l WHERE l.idKorisnik='".$idKorisnik."'";
    ...
    <div class="centriranje">
        <form method="POST" action="updateS.php" style="text-align: center;">
            <h2>Koji predlog biste izmenili?</h2>
            ...
            <br><br>
            <h2>Šta biste izmenili?</h2>
            <label for="msg">Unesite mesto i državu</label><br><br>
            <textarea style="resize: none;" name="mesto" cols="50" rows="5" required></textarea><br><br>
            <label for="zasto">Zašto?</label><br><br>
            <textarea style="resize: none;" name="zasto" cols="50" rows="5" required></textarea><br><br>
            <button type="submit" name="updateS">Izmeni</button>
            <br> <br>
        </form>
    </div>
    <footer>
