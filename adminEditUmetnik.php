...
<body>
    ...
    <h2 style="text-align: center;">Admin Panel | Izmeni umetnika</h2>
...
<div class="centriranjeBody2">
    <form method="POST" action="editUmetnik.php" style="text-align: center;">
        <h2>Izmeni umetnika:</h2>
        <select name="idIzvodjac" required>
            <option value="">Izaberite umetnika za izmenu</option>
        ...
        <br><br>
        <button type="submit" name="editUmetnik">Izmeni</button>
        <br><br>
    </form>
